...
# 5. 训练流程
# =============================================================================
def train_model(window_size, window_stride, train_file_path, model_save_path, num_epochs=50, batch_size=32, lr=0.001, hidden_size=50, num_layers=1, dropout=0.5, weight_decay=1e-4):
    # 初始化 wandb
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_save_path", type=str, default="lstm_model.pth", help="Path to save the trained model.")
